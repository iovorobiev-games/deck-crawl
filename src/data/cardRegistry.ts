...
export const cardRegistry: Record<string, CardData> = {
  ...
  vengeful_revenant: { id: "vengeful_revenant", goldValue: 16, type: CardType.Monster, name: "Vengeful Revenant", value: 2, description: "[t]On Death:[/t] Returns back to the Dungeon Deck and gets Misfortune tag. \n-1 [pow]", image: "vengeful_revenant", abilities: [{ abilityId: "return_conditional", params: { returnTag: "misfortune" } }, { abilityId: "power_drain", params: { amount: -1 } }] },
  crypt_lord: { id: "crypt_lord", goldValue: 13.71, type: CardType.Monster, name: "Crypt Lord", value: 3, description: "Hides the Key!\n[t]On Death:[/t] Returns to the Dungeon Deck\n[t]On Explore:[/t] Shuffles [c]Skeleton[/c]", image: "crypt_lord", abilities: [{ abilityId: "summonToDeck", params: { cardId: "skeleton_warrior", count: 1 } }, { abilityId: "return_conditional", params: { requiredDiscardId: "phylactery" } }] },
  ...
  elven_bow: { id: "elven_bow", goldValue: 10.5, type: CardType.Treasure, name: "Elven Bow", value: 0, description: "[t]On Equip:[/t] Adds 3 [c]Strong Bow Shot[/c] cards into a dungeon deck.", slot: "weapon", image: "elven_bow", tag: "bow", agilityBonus: 1, abilities: [{ abilityId: "equip_degrade", params: { cardId: "strong_bow_shot", count: 3 } }] },
  ...
  scroll_of_cleansing: { id: "scroll_of_cleansing", goldValue: 3.47, type: CardType.Treasure, name: "Scroll of Cleansing", value: 0, description: "[t]On Self:[/t] Removes top Misfortune from the deck", slot: "backpack", image: "scroll_of_cleansing", tag: "scroll", abilities: [{ abilityId: "remove_dark_event", params: {} }] },
  ...
  // --- Events ---
  attack_from_shadows: { id: "attack_from_shadows", goldValue: 2, type: CardType.Event, name: "Attack from Shadows", value: 1, description: "Deals 1 Damage to the Hero", image: "attack_from_shadows", tag: "misfortune", abilities: [{ abilityId: "attack_from_shadows", params: { amount: 1 } }] },
  dark_ritual: { id: "dark_ritual", goldValue: 1.88, type: CardType.Event, name: "Dark Ritual", value: 0, description: "[t]On Reveal:[/t] Insert [c]Terrible Tentacle[/c] to the dungeon deck", image: "dark_ritual", tag: "misfortune", abilities: [{ abilityId: "dark_ritual_summon", params: { cardId: "terrible_tentacle", count: 1 } }] },
  deadly_poisoning: { id: "deadly_poisoning", goldValue: 2, type: CardType.Event, name: "Deadly Poisoning", value: 1, description: "-1[hp]", image: "poison", tag: "misfortune", abilities: [{ abilityId: "deadly_poison_damage", params: { amount: 1, ignoresArmor: 1 } }] },
  weapon_degradation: { id: "weapon_degradation", goldValue: 8, type: CardType.Event, name: "Weapon Degradation", value: 0, description: "-1[pow] of currently equipped weapon", image: "weapon_degradation", tag: "misfortune", abilities: [{ abilityId: "weapon_degrade", params: { amount: 1 } }] },
