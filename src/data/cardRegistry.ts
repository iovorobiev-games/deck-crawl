...
export const cardRegistry: Record<string, CardData> = {
  ...
  // --- Potions ---
  health_potion: { id: "health_potion", goldValue: 8, type: CardType.Potion, name: "Healing Potion", value: 4, description: "Heals 4 HP", slot: "backpack", image: "healing_potion", abilities: [{ abilityId: "healing", params: { amount: 4 } }] },
  lesser_health_potion: { id: "lesser_health_potion", goldValue: 4, type: CardType.Potion, name: "Lesser Health Potion", value: 2, description: "Restores 2HP", slot: "backpack", image: "healing_potion", abilities: [{ abilityId: "healing", params: { amount: 2 } }] },
  minor_health_potion: { id: "minor_health_potion", goldValue: 6, type: CardType.Potion, name: "Minor Health Potion", value: 3, description: "Restores 3HP", slot: "backpack", image: "healing_potion", abilities: [{ abilityId: "healing", params: { amount: 3 } }] },

  // --- Traps ---
  spike_trap: { id: "spike_trap", goldValue: 2.67, type: CardType.Trap, name: "Spike Trap", value: 2, description: "Deals 2 damage", lockDifficulty: 2, trapDamage: 2, image: "bear_trap" },
  spike_trap_heavy: { id: "spike_trap_heavy", goldValue: 6.67, type: CardType.Trap, name: "Spike Trap", value: 4, description: "Deals 4 damage", lockDifficulty: 3, trapDamage: 4, image: "pressure_plate" },
  poison_gas: { id: "poison_gas", goldValue: 5, type: CardType.Trap, name: "Poison Gas", value: 3, description: "Deals 3 damage", lockDifficulty: 3, trapDamage: 3, image: "poison_dart_trap" },
  ...
  // --- Treasure - Shields ---
  wooden_shield: { id: "wooden_shield", goldValue: 4, type: CardType.Treasure, name: "Wooden Shield", value: 0, description: "Blocks 2 Damage", slot: "weapon", image: "wooden_shield", abilities: [{ abilityId: "armour", params: { amount: 2 } }] },
  ...
  scroll_of_fire_bolt: { id: "scroll_of_fire_bolt", goldValue: 4, type: CardType.Treasure, name: "Scroll of Fire Bolt", value: 0, description: "Reduces Enemy Power By 2", slot: "backpack", image: "scroll_of_firebolt", tag: "scroll", abilities: [{ abilityId: "reduce_target_monster", params: { amount: 2, vfx: "fireball" } }] },
  scroll_of_cleansing: { id: "scroll_of_cleansing", goldValue: 3.47, type: CardType.Treasure, name: "Scroll of Cleansing", value: 0, description: "On Discard: Removes top Curse from the deck", slot: "backpack", image: "scroll_of_cleansing", tag: "scroll", abilities: [{ abilityId: "remove_dark_event", params: {} }] },
  ...
  crude_axe: { id: "crude_axe", goldValue: 14, type: CardType.Treasure, name: "Crude Axe", value: 2, description: "Degrades", slot: "weapon", image: "crude_axe", abilities: [{ abilityId: "equip_degrade", params: { cardId: "weapon_degradation", count: 1 } }] },

  // --- Events ---
  attack_from_shadows: { id: "attack_from_shadows", goldValue: 2, type: CardType.Event, name: "Attack from Shadows", value: 1, description: "Deals 1 Damage to the player", image: "attack_from_shadows", tag: "curse", abilities: [{ abilityId: "attack_from_shadows", params: { amount: 1 } }] },
  ...
  deadly_poisoning: { id: "deadly_poisoning", goldValue: 2, type: CardType.Event, name: "Deadly Poisoning", value: 1, description: "Poison courses through your veins", image: "poison", tag: "curse", abilities: [{ abilityId: "deadly_poison_damage", params: { amount: 1, ignoresArmor: 1 } }] },
  ...
  iron_chest: { id: "iron_chest", goldValue: 6, type: CardType.Chest, name: "Iron Chest", value: 0, description: "Trap: -3 HP", lockDifficulty: 4, trapDamage: 3, image: "hardened_chest" },
  iron_chest_heavy: { id: "iron_chest_heavy", goldValue: 8, type: CardType.Chest, name: "Iron Chest", value: 0, description: "Trap: -4 HP", lockDifficulty: 5, trapDamage: 4, image: "posh_chest" },
  ominous_chest: { id: "ominous_chest", goldValue: 5.33, type: CardType.Chest, name: "Ominous Chest", value: 0, description: "Trap: -4 HP", lockDifficulty: 2, trapDamage: 4, image: "ominuous_chest" },
  rusty_chest: { id: "rusty_chest", goldValue: 2, type: CardType.Chest, name: "Rusty Chest", value: 0, description: "Trap: -3 HP", lockDifficulty: 1, trapDamage: 3, image: "strong_chest" },
  trapped_chest: { id: "trapped_chest", goldValue: 4, type: CardType.Chest, name: "Trapped Chest", value: 0, description: "Trap: -3 HP", lockDifficulty: 2, trapDamage: 3, image: "posh_chest" },
  hardened_chest: { id: "hardened_chest", goldValue: 1.67, type: CardType.Chest, name: "Hardened Chest", value: 0, description: "Trap: -1 HP", lockDifficulty: 3, trapDamage: 1, image: "hardened_chest" },
