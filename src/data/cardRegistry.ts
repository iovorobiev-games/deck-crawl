...
export const cardRegistry: Record<string, CardData> = {
  ...
  crypt_lord: { id: "crypt_lord", goldValue: 13.71, type: CardType.Monster, name: "Crypt Lord", value: 3, description: "Goes back to dungeon deck after death unless Phylactery is discarded.\n Adds Skeleton to the Dungeon Deck on Explore", image: "crypt_lord", abilities: [{ abilityId: "summonToDeck", params: { cardId: "skeleton_warrior", count: 1 } }, { abilityId: "return_conditional", params: { requiredDiscardId: "phylactery", upgradeCardId: "crypt_lord_boss" } }] },
  crypt_lord_boss: { id: "crypt_lord_boss", goldValue: 13.71, type: CardType.Monster, name: "Crypt Lord", value: 5, description: "Goes back to dungeon deck after death unless Phylactery is discarded.\n Adds Skeleton to the Dungeon Deck on Explore", image: "crypt_lord", abilities: [{ abilityId: "summonToDeck", params: { cardId: "skeleton_warrior", count: 1 } }] },

  // --- Tentacle chain ---
  terrible_tentacle: { id: "terrible_tentacle", goldValue: 24, type: CardType.Monster, name: "Terrible Tentacle", value: 6, description: "If 2 other Tentacles are on the grid, summon Terror From The Beyond", image: "horrendous_tentacle", abilities: [{ abilityId: "terrible_summon", params: { cardId: "terror_from_beyond", count: 1, requiredOtherCount: 2 } }] },
  ...
  dark_ritual: { id: "dark_ritual", goldValue: 1.88, type: CardType.Event, name: "Dark Ritual", value: 0, description: "When Resolved insert Terrible Tentacle to the dungeon deck", image: "dark_ritual", tag: "curse", abilities: [{ abilityId: "dark_ritual_summon", params: { cardId: "terrible_tentacle", count: 1 } }] },
