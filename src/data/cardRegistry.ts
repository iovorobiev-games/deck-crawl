...
export const cardRegistry: Record<string, CardData> = {
  ...
  lesser_health_potion: { id: "lesser_health_potion", type: CardType.Potion, name: "Lesser Health Potion", value: 2, description: "Restores 2HP", slot: "backpack", image: "healing_potion", abilities: [{ abilityId: "healing", params: { amount: 2 } }] },
  minor_health_potion: { id: "minor_health_potion", type: CardType.Potion, name: "Minor Health Potion", value: 3, description: "Restores 3HP", slot: "backpack", image: "healing_potion", abilities: [{ abilityId: "healing", params: { amount: 3 } }] },
  ...
  gold_pile_3: { id: "gold_pile_3", type: CardType.Treasure, name: "Pile of Gold", value: 3, description: "3 Gold Coins", image: "pile_of_gold" },
  gold_pile_medium: { id: "gold_pile_medium", type: CardType.Treasure, name: "Pile of Gold", value: 4, description: "4 Gold Coins", image: "pile_of_gold" },
  ...
  // --- Doors ---
  hall_door: { id: "hall_door", type: CardType.Door, name: "Hall Door", value: 0, description: "Open with the key", deckLevel: 1, image: "door" },
