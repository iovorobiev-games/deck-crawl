...
export const deckConfig: DeckEntry[] = [
  ...
  { type: CardType.Trap, name: "Spike Trap", value: 2, description: "Deals 2 damage", count: 3, lockDifficulty: 2 },
  ...
  { type: CardType.Trap, name: "Poison Gas", value: 3, description: "Deals 3 damage", count: 2, lockDifficulty: 3 },
